/**
 * worker.js - Cloudflare Worker + Static Assets 엔트리포인트
 * /api/status 및 /api/extract를 처리하고 나머지는 정적 웹 파일(ASSETS)로 전달
 */
      ...
      try {
        ...
        if (!apiKey || apiKey.trim() === '') {
          return new Response(JSON.stringify({
            ...
            message: 'Cloudflare 환경변수에 OPENROUTER_API_KEY가 설정되지 않았습니다. Cloudflare 대시보드에서 등록해 주세요.'
          }), {
            status: 500,
